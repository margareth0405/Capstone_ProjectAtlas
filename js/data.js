...
const defaultLibraryData = [
    ...
    { 
        ...
        details: 'Comprehensive guide to Java fundamentals and object-oriented programming. Covers Java 17 features.',
        fileType: 'PDF',
        fileSize: '8.5 MB',
        pages: 1234,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'In-depth coverage of database design, SQL, and management. Includes NoSQL and cloud databases.',
        fileType: 'PDF',
        fileSize: '12.2 MB',
        pages: 768,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'Clear and engaging introduction to economic principles. Covers micro and macroeconomics.',
        fileType: 'PDF',
        fileSize: '15.3 MB',
        pages: 936,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Brian Greene', 
        details: 'Introduction to quantum mechanics and its applications. Explains complex concepts in simple terms.',
        fileType: 'EPUB',
        fileSize: '4.1 MB',
        pages: 352,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Paul C. Smith', 
        details: 'Comprehensive guide to psychological research methods. Covers qualitative and quantitative approaches.',
        fileType: 'PDF',
        fileSize: '6.8 MB',
        pages: 584,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'Master data structures and algorithms with practical Java examples. Covers trees, graphs, and sorting.',
        fileType: 'PDF',
        fileSize: '9.7 MB',
        pages: 800,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'James Kurose', 
        details: 'Comprehensive guide to computer networking. Covers TCP/IP, routing, and network security.',
        fileType: 'PDF',
        fileSize: '14.6 MB',
        pages: 880,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'John Wiley', 
        details: 'Essential statistics for data science. Covers probability, hypothesis testing, and regression analysis.',
        fileType: 'EPUB',
        fileSize: '3.9 MB',
        pages: 448,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'The definitive AI textbook. Covers search, reasoning, planning, and machine learning.',
        fileType: 'PDF',
        fileSize: '22.1 MB',
        pages: 1152,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Jon Duckett', 
        details: 'Complete guide to modern web development. Covers responsive design, CSS frameworks, and JavaScript ES6.',
        fileType: 'PDF',
        fileSize: '11.3 MB',
        pages: 704,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'Latest biotech research and innovations. Features CRISPR, gene therapy, and synthetic biology.',
        fileType: 'PDF',
        fileSize: '5.2 MB',
        pages: 124,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Elsevier', 
        details: 'Global health research and policy analysis. Covers pandemic response, healthcare systems, and epidemiology.',
        fileType: 'PDF',
        fileSize: '4.8 MB',
        pages: 96,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'Exploring the intersection of AI and social sciences. Topics include ethics, bias, and future of work.',
        fileType: 'PDF',
        fileSize: '3.4 MB',
        pages: 88,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'NEJM Group', 
        details: 'Premier medical journal. Latest research in clinical medicine, cardiology, and oncology.',
        fileType: 'PDF',
        fileSize: '6.1 MB',
        pages: 112,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'AAAS', 
        details: 'Multidisciplinary scientific journal. Covers physics, chemistry, biology, and environmental science.',
        fileType: 'PDF',
        fileSize: '7.3 MB',
        pages: 156,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'IEEE', 
        details: 'Leading software engineering journal. Covers development methodologies, testing, and software maintenance.',
        fileType: 'PDF',
        fileSize: '4.2 MB',
        pages: 104,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'Research on technology in education. Covers e-learning, educational software, and digital literacy.',
        fileType: 'PDF',
        fileSize: '3.1 MB',
        pages: 72,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'Environmental research. Covers climate change, pollution, renewable energy, and sustainability.',
        fileType: 'PDF',
        fileSize: '5.7 MB',
        pages: 136,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Dr. A. Sharma', 
        details: 'Research paper on ML applications in medical diagnosis. Focuses on disease prediction and treatment optimization.',
        fileType: 'PDF',
        fileSize: '2.3 MB',
        pages: 45,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Dr. L. Chen', 
        details: 'Study on the impact of climate change on biodiversity. Includes case studies from tropical rainforests.',
        fileType: 'PDF',
        fileSize: '3.8 MB',
        pages: 62,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Dr. M. Patel', 
        details: 'Research on renewable energy and sustainability. Covers solar, wind, and hydrogen energy systems.',
        fileType: 'PDF',
        fileSize: '4.1 MB',
        pages: 78,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'Research on modern cybersecurity threats and defenses. Covers AI-driven security, zero-trust architecture.',
        fileType: 'PDF',
        fileSize: '2.9 MB',
        pages: 54,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Dr. S. Kim', 
        details: 'Research on nanomedicine applications. Covers drug delivery, diagnostics, and regenerative medicine.',
        fileType: 'PDF',
        fileSize: '3.2 MB',
        pages: 58,
        downloadUrl: '#',
    ...
    { 
        ...
        details: 'Research on space technologies. Covers propulsion systems, satellite technology, and deep space missions.',
        fileType: 'PDF',
        fileSize: '5.6 MB',
        pages: 92,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'DepEd', 
        details: 'Complete curriculum guide for Grade 10 Mathematics. Covers algebra, geometry, and statistics.',
        fileType: 'PDF',
        fileSize: '1.8 MB',
        pages: 120,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'DepEd', 
        details: 'Comprehensive ELA curriculum guide for high school. Covers reading, writing, and literary analysis.',
        fileType: 'PDF',
        fileSize: '2.1 MB',
        pages: 145,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'DepEd', 
        details: 'Complete science curriculum for Grade 8. Covers physics, chemistry, biology, and earth science.',
        fileType: 'PDF',
        fileSize: '1.5 MB',
        pages: 98,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'DepEd', 
        details: 'World history curriculum for high school. Covers ancient to modern civilizations.',
        fileType: 'PDF',
        fileSize: '1.9 MB',
        pages: 110,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Science Dept.', 
        details: 'Hands-on activity sheets for chemistry experiments. Includes lab safety, chemical reactions, and acids & bases.',
        fileType: 'PDF',
        fileSize: '3.4 MB',
        pages: 32,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Math Dept.', 
        details: 'Practice problems for algebra students. Covers equations, functions, and graphing.',
        fileType: 'PDF',
        fileSize: '2.2 MB',
        pages: 28,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'English Dept.', 
        details: 'Grammar practice worksheets for high school students. Covers tenses, parts of speech, and sentence structure.',
        fileType: 'PDF',
        fileSize: '1.9 MB',
        pages: 24,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Science Dept.', 
        details: 'Physics activity sheets for Grade 10. Covers forces, motion, energy, and simple machines.',
        fileType: 'PDF',
        fileSize: '2.7 MB',
        pages: 30,
        downloadUrl: '#',
    ...
    { 
        ...
        author: 'Math Dept.', 
        details: 'Geometry practice problems for high school students. Covers shapes, angles, proofs, and trigonometry.',
        fileType: 'PDF',
        fileSize: '2.4 MB',
        pages: 26,
        downloadUrl: '#',
...
function getRecentItems(count = 6) {
    const sorted = [...libraryData].sort((a, b) => {
        const dateA = a.createdAt ? new Date(a.createdAt) : new Date(a.id * 1000000);
        const dateB = b.createdAt ? new Date(b.createdAt) : new Date(b.id * 1000000);
        return dateB - dateA;
    });
...
function getLibraryStats() {
    ...
    const totalPages = libraryData.reduce((sum, item) => sum + (item.pages || 0), 0);
    
    console.log('📊 E-Library Stats:', { totalItems, uniqueTypes, uniqueAuthors, totalPages });
...
function downloadItem(itemId) {
    ...
    showToast(`📥 Downloading "${item.title}" (${item.fileType}, ${item.fileSize})...`);
...
console.log(`📚 Books: ${defaultLibraryData.filter(i => i.collection === 'Book').length}`);
console.log(`📚 Journals: ${defaultLibraryData.filter(i => i.collection === 'Journal').length}`);
console.log(`📚 Research: ${defaultLibraryData.filter(i => i.collection === 'Research').length}`);
console.log(`📚 Curriculum Guides: ${defaultLibraryData.filter(i => i.collection === 'Curriculum Guide').length}`);
console.log(`📚 Activity Sheets: ${defaultLibraryData.filter(i => i.collection === 'Activity Sheets').length}`);