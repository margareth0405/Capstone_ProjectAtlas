...
// Student: View, Download, Favorite (No Add, Edit, Delete)
...
function renderFavoritesList() {
    const favoritesSection = document.querySelector('.student-favorites-section');
    ...
    favorites.forEach(item => {
        ...
        switch (item.collection) {
            case 'Book': badgeClass = 'book'; break;
            case 'Research': badgeClass = 'research'; break;
            case 'Curriculum Guide': badgeClass = 'guide'; break;
            case 'Activity Sheets': badgeClass = 'sheets'; break;
            case 'Journal': badgeClass = 'journal'; break;
            default: badgeClass = '';
        }
